...
//import mainHeroImage from './images/purple_main_hero_image01.png';
...
const LoopingAnimatedSvg = () => {
  ...
  useEffect(() => {
    // Total duration of one animation cycle (adjust based on your animation length)
    const animationDuration = 20000; // 20 seconds

    const timer = setInterval(() => {
      // Force re-render of AnimatedSvg by changing its key
...
// Add state for managing open/closed states
...
const handlePlayClick = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-between h-16">
      ...
      {/* Hero Section */}
      <header className="min-h-screen pt-16 relative overflow-hidden">
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-blue-600/20 to-[#0a0a0a]">
        
        {/* Content Container */}
        <div className="relative z-10 pt-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full items-center">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-2 pt-4">
                <button className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-4 rounded-full text-xl font-semibold hover:opacity-90 transition-all duration-300 flex items-center justify-center gap-2 group">
                  Pre-Book Your Slot Now 
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
                </button>
                <div className="flex flex-row gap-2 text-center mx-auto"> {/* Added flex and flex-row */}
            ...
            <div className="hidden lg:block lg:col-span-7 relative pt-16">
              ...
              <div className="w-full h-auto mx-auto"> 
                ...
                <img
        src={mainHeroImage}
        alt="beautiful apps main image"
        className="w-full z-10000 mx-auto object-contain rounded-lg shadow-6xl  mb-5 animate-custom-bounce duration-500"
      />
              </div>      
            </div>
 ...
 {/* Column 2: Latest Blog Posts */}
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <a href="mailto:team@buildbeautifulapps.com" className="flex items-center gap-3 text-gray-400 hover:text-blue-400 transition-colors">
            <Mail className="w-5 h-5" />
            <span>team@buildbeautifulapps.com</span>
          </a>
        </div>
      </div>
    </div>
    ...
    <div className="mt-16 pt-8 border-t border-gray-800 text-center text-gray-400">
      <p>&copy; {new Date().getFullYear()} Beautiful Apps. All rights reserved.</p>
    </div>
  </div>
